...
PPD_TABS = "ppd-tabs"
PPD_TABLIST = "ppd-tablist"
PPD_TABSPANEL = "ppd-tabspanel"
...
PPD_FROM_DATE_PICKER_BUTTON = "ppd-from-date-picker-button"
...
PPD_FIRST_CHART_LEFT_GRID = "ppd-first-chart-left-grid"
