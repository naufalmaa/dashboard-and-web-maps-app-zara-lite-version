...
def render(app: Dash, source: DataSource) -> html.Div:
    ...
    def plot_map(block_name_multi_value: list[str], map_color_chosen: str, well_name_multi_value: list[str]) -> html.Div:
        ...
        series_geometry_well = edited_wells.to_dataframe_geopandas_temp['geometry']
        # edited
        ...
        layer_wells = dl.GeoJSON(id='point_load',
